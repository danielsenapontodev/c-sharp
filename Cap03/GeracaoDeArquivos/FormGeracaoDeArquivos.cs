...
{
    public partial class FormGeracaoDeArquivos : Form
    {
        public FormGeracaoDeArquivos()
        {
            InitializeComponent();
        ...
        private void btnCriarLinhas_Click(object sender, System.EventArgs e)
        {
        ...
        private void btnCriarArquivo_Click(object sender, EventArgs e)
        {
            if (!ValidaDados())
            {
                MessageBox.Show("Os dados possuem problemas. Verifique se não deixou nenhum nome em branco ou se " +
                    "existe um valor correto para os salários de cada um");
            }
